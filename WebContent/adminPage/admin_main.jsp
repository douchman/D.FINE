...
<body>
	...
	<div id="sideMenu" style="float: left; position:fixed;">
		<h4 class="glyphicon glyphicon-align-justify"> Admin Menu</h4>
		<hr />
		<ul>
			<li><a id="Member" href="#" onclick="getView(this.id)">
			<span class="glyphicon glyphicon-user" aria-hidden="true"> 전체 회원 관리
			</span></a>
			</li>
	...
	<!-- 뷰 필드 -->
	<div id="adminPage_view" class="container">
...
<script src="<%=request.getContextPath()%>/js/adminPage.js"></script>
</body>
</html>
